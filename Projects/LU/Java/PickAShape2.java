...
public class PickAShape2{
	public static void main(String[] args)throws IOException{
		...
		do{
			...
			if ((choice >= 1) && (choice <= 7)){
				...
				System.out.println("You did not make a choice!!!"+"\n");
			}
		} while (choice != 7);
	...
	public static int GetSize(int size, int ShapeMsg, int MsgFlag)throws IOException{
		...
		do{
			switch(ShapeMsg){
				case 1:
					System.out.print("Please enter the length of one side of the square - 2 is the smallest, more than 100 might be too big: ");
				break;
				case 2:
					if (MsgFlag == 1){
						System.out.print("Please enter the length of side one for the rectangle: ");	
					}
					else{
						if (MsgFlag == 2){
							System.out.print("Please enter the length of side two for the rectangle: ");
						}
					}
				break;
				case 3:
					System.out.print("Please enter one side of the triangle: ");
				break;
				case 4:
					System.out.print("Please enter one side of the diamond: ");
				break;
				case 5:
					System.out.print("Please enter the radius of the circle: ");
				break;
				case 6:
					System.out.print("Please enter the radius of the smiley face: ");
				break;
				case 7:
				break;
				case 8:
